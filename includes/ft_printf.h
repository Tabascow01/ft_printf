...
/*   Updated: 2017/03/27 06:21:48 by mchemakh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_dgt_2(t_flags *list, int *dgttmp, int *size, int *dgt);
void				ft_dgt_1(t_flags *list, int *dgttmp, char *fdgt, int *size);
